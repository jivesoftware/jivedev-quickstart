...
$.get('/wp-content/uploads/2015/06/meta.json', function(data) {
    src.meta_json = data;
});
$.get('/wp-content/uploads/2015/06/definition.json', function(data) {
    src.definition_json = data;
});

$.get('/wp-content/uploads/2015/06/common.js', {}, function(data) {
    src.public.common_js = data;
}, 'text');
$.get('/wp-content/uploads/2015/06/config-adaptor.js', {}, function(data) {
    src.public.config_adaptor_js = data;
}, 'text');
$.get('/wp-content/uploads/2015/06/configuration.html', function(data) {
    src.public.configuration_html = data;
});
$.get('/wp-content/uploads/2015/06/diagnostics.js', {}, function(data) {
    src.public.diagnostics_js = data;
}, 'text');
$.get('/wp-content/uploads/2015/06/jive-ee.css', function(data) {
    src.public.jive_ee_css = data;
});
$.get('/wp-content/uploads/2015/06/main1.js', {}, function(data) {
    src.public.main_js = data;
}, 'text');
$.get('/wp-content/uploads/2015/06/style.css', function(data) {
    src.public.style_css = data;
});

$.get('/wp-content/uploads/2015/06/xform.js', function(data) {
